...
对应 note：`digests/2026-06-18/ben-eysenbach-self-supervised-rl-series.md`
...
对应 notes：`digests/2026-06-18/amy-zhang-rl-abstraction-hierarchy.md`；`digests/2026-06-18/amy-zhang-representations-hierarchical-rl.md`
...
对应 notes：`digests/2026-05-08/welch-labs-imaginary-numbers-are-real-part-1-introduction.md`；`digests/2026-05-08/welch-labs-imaginary-numbers-are-real-complex-numbers-for-fourier-and-physics.md`；`digests/2026-05-10/optimal-transport-geometric-view-deep-learning.md`。
...
对应 notes：`digests/2026-04-12/takahiro-sagawa-stochastic-thermodynamics.md`；`digests/2026-04-12/landauer-to-generative-models.md`；`digests/2026-04-12/bernard-derrida-large-deviations-of-non-equilibrium-diffusive-systems.md`；`digests/2026-04-12/brunton-hnn-notes.md`；`digests/2026-05-08/max-welling-iclr2026-from-physics-to-ai-to-materials.md`。
...
对应 notes：`digests/2026-05-08/david-ha-world-models-neurips-2018.md`；`digests/2026-04-15/xie-saining-world-model-interview.md`；`digests/2026-04-16/xie-saining-representation-learning-roadmap.md`；`digests/2026-04-16/world-model-as-learned-nonequilibrium-dynamics.md`；`digests/2026-05-06/yann-lecun-billion-dollar-bet-against-llms.md`；`digests/2026-05-10/bycloud-yann-lecun-jepa-explained.md`；`digests/2026-05-10/kaiming-he-learning-deep-representations.md`；`digests/2026-05-06/energy-based-transformers-scalable-learners-and-thinkers.md`；`digests/2026-06-18/iclr2026-latent-particle-world-models.md`；`digests/2026-06-18/iclr2026-locality-aware-parallel-decoding.md`；`digests/2026-06-18/iclr2026-sana-video-efficient-video-generation.md`。
...
对应 notes：`digests/2026-06-18/richard-sutton-rl-experience-vs-llm-imitation.md`；`digests/2026-05-10/david-silver-era-of-experience.md`；`digests/2026-06-18/ben-eysenbach-self-supervised-rl-series.md`；`digests/2026-06-18/amy-zhang-rl-abstraction-hierarchy.md`；`digests/2026-06-18/amy-zhang-representations-hierarchical-rl.md`；`digests/2026-05-10/jim-fan-minedojo-open-ended-embodied-agents.md`；`digests/2026-05-10/jim-fan-robotics-end-game.md`；`digests/2026-05-10/percy-liang-self-training-unsupervised-domain-adaptation.md`；`digests/2026-06-18/iclr2026-gepa-reflective-prompt-evolution.md`；`digests/2026-06-18/yao-shunyu-anthropic-gemini-model-training-interview.md`。
...
- Ben Eysenbach self-supervised RL lecture notes：`digests/2026-06-18/ben-eysenbach-self-supervised-rl-series.md`；对应 slides 位于 `youtube/slides/ben-eysenbach-self-supervised-rl-series-curated`。
- Amy Zhang RL abstraction / hierarchy lecture notes：`digests/2026-06-18/amy-zhang-rl-abstraction-hierarchy.md`；`digests/2026-06-18/amy-zhang-representations-hierarchical-rl.md`。
