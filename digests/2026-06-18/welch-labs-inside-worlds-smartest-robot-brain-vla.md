...
![SayCan task decomposition](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/03_00-02-05_saycan-task-decomposition.jpg)
...
![RT-1 larger imitation control layer](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/04_00-03-20_rt-1-larger-imitation-control-layer.jpg)
...
![PaLM-E multimodal planner](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/05_00-04-38_palm-e-multimodal-planner.jpg)
...
![RT-2 absorbs action into multimodal LLM](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/07_00-07-20_rt-2-absorbs-action-into-multimodal-llm.jpg)
...
![Pi Zero parameter and onboard inference contrast](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/09_00-10-35_pi-zero-parameter-and-onboard-inference-contrast.jpg)
...
![Action expert module](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/11_00-12-24_action-expert-module.jpg)
...
![Image patch embeddings as soft tokens](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/12_00-14-15_image-patch-embeddings-as-soft-tokens.jpg)
...
![Attention connects pen token to image patches](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/13_00-17-50_attention-connects-pen-token-to-image-patches.jpg)
...
![Flow matching starts from random action trajectories](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/15_00-22-30_flow-matching-starts-from-random-action-trajectories.jpg)

action expert 接收机器人当前关节状态，以及未来动作轨迹的随机初始版本。以 ALOHA 双臂平台为例，两个手臂共 14 个控制维度，Pi Zero 要生成未来 50 个时间步的动作，所以动作可以看成一个 14 x 50 的矩阵。

![Robot action trajectory as 14 by 50 matrix](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/16_00-23-20_robot-action-trajectory-as-14-by-50-matrix.jpg)
...
![KV cache reused during action denoising](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/18_00-27-45_kv-cache-reused-during-action-denoising.jpg)
...
![Demo caveat and world model contrast](../../youtube/slides/2mrGMMmrVNE-inside-the-worlds-smartest-robot-brain-vla/semantic_curated/19_00-29-25_demo-caveat-and-world-model-contrast.jpg)
