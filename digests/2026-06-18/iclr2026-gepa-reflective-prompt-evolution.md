...
![Agents for real-world applications](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/03-agents-real-world-applications.jpg)
...
![RL with verified rewards](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/04-rl-with-verified-rewards.jpg)
...
![Reflective optimization](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/05-reflective-optimization-text-space.jpg)
...
![GEPA overview](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/06-gepa-evolutionary-prompt-optimization.jpg)
...
![GEPA vs GRPO](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/07-gepa-vs-grpo-multihop-qa.jpg)
...
![Complete system specification](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/08-complete-system-specification.jpg)
...
![Pareto diversity and quality](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/10-pareto-diversity-quality.jpg)

Pareto 选择保留多个互补候选：有的在样本 A 上强，有的在样本 B 上强。这样 mutation 的出发点不会过早收缩到单一模式，探索和利用之间更平衡。

![Prompt optimizer choices](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/11-prompt-optimizer-choices.jpg)
...
![Optimization with smarter proposers](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/12-optimization-with-smarter-proposers.jpg)
...
![Optimize anything API](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/13-optimize-anything-api.jpg)
...
![Agent architecture discovery](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/14-agent-architecture-discovery.jpg)

![VLM OCR performance](../../youtube/slides/HbGah-uP1fI-gepa-reflective-prompt-evolution-can-outperform-reinforcement-learning/curated/15-vlm-ocr-performance.jpg)
