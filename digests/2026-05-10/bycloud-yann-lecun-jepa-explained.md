...
- Creator: bycloud
- Transcript: [transcript.md](../../youtube/transcripts/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/transcript.md)
- Slides: [curated/index.md](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/index.md)
...
![JEPA question](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/01-jepa-question.jpg)
...
![JEPA architecture](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/02-jepa-architecture.jpg)
...
![Latent view objective](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/03-latent-view-objective.jpg)
...
![V-JEPA latent prediction](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/04-vjepa-latent-prediction.jpg)
...
![Representation collapse](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/05-representation-collapse.jpg)
...
![InfoMax and contrastive learning](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/06-infomax-paper.jpg)
...
![LeJEPA paper](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/07-lejepa-paper.jpg)
...
![Isotropic Gaussian geometry](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/08-isotropic-gaussian-results.jpg)

这一步的逻辑很重要。collapse 的问题本质上是几何问题：representation space 的体积退化了。LeJEPA 用分布形状约束来直接防止这种退化，让 embedding space 保持足够维度和足够信息量。

![Embedding geometry](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/09-geometry-of-embedding.jpg)
...
![JEPA versus LLM data](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/10-jepa-vs-llm-data.jpg)
...
![EchoJEPA and ultrasound](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/11-echo-jepa.jpg)
...
![Ultrasound distortions](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/12-ultrasound-distortions.jpg)

医生真正关心的是更稳定的解剖和生理结构：心腔大小、心壁运动、瓣膜开合、节律和收缩模式。这些信息不一定需要像素级复原，但需要在 representation 中被稳定保留。

![EchoJEPA results](../../youtube/slides/oM4neOyZOi0-what-is-yann-lecun-cooking-jepa-explained-simply/curated/13-echo-results.jpg)
