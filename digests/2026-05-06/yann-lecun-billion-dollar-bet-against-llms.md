...
![00:00:24 LLM 的两个常见标签被划掉：不把问题只理解成 language pretraining 或 generative AI](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-00-24_llm_not_language_or_generative.jpg)
...
![01:43 从 CNN、LeNet、AlexNet 到 GPT，视频把 LeCun 的路线放进深度学习历史分叉中](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-01-43_two_paths_roadmap.jpg)
...
![12:31 语言模型可以把不确定性放在离散 token 概率上](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-12-31_language_vs_video_uncertainty.jpg)
...
![13:14 像素级视频预测在多种可能未来之间取平均，会得到模糊结果](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-13-14_blurry_video_average.jpg)
...
![15:25 Siamese network 是 joint embedding 路线的早期形态：两个输入先进入共享或相似网络，再比较 embedding](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-15-25_siamese_joint_embedding.jpg)
...
![17:14 两个不同视图进入 encoder 后得到相似 embedding，这是 joint embedding 的直观目标](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-17-14_view_embedding_alignment.jpg)
...
![18:28 如果所有输入都输出同一个向量，模型虽然满足“相似”约束，却失去了区分能力](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-18-28_representation_collapse.jpg)
...
![23:40 cross-correlation matrix 把不同 embedding 维度之间的冗余显式写出来](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-23-40_cross_correlation_matrix.jpg)
...
![24:23 理想目标是接近单位矩阵：对角线对齐，非对角线去冗余](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-24-23_identity_matrix_objective.jpg)
...
![28:49 patch embedding similarity 展示的是模型在不做像素重建的情况下学到图像内部结构](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-28-49_patch_embedding_similarity.jpg)
...
![32:03 JEPA 把当前观测和未来观测都编码成 embedding，然后训练 predictor 做 latent prediction](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-32-03_jepa_architecture.jpg)
...
![33:03 action-conditioned JEPA 可以把目标图像编码成 goal embedding，再搜索动作序列](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-33-03_goal_conditioned_planning.jpg)
...
![34:42 路线图回到两条路径的对比：生成式 AI 与 joint embedding 指向不同的系统设计](../../youtube/slides/kYkIdXwW2AE-yann-lecuns-1b-bet-against-llms/curated/00-34-42_jepa_family_roadmap.jpg)
