...
![Function shift](../../youtube/slides/T647CGsuOVU-imaginary-numbers-are-real-part-1-introduction/curated/01-function-shift.jpg)
...
![Inverse question](../../youtube/slides/T647CGsuOVU-imaginary-numbers-are-real-part-1-introduction/curated/02-inverse-function-question.jpg)
...
![Natural numbers](../../youtube/slides/T647CGsuOVU-imaginary-numbers-are-real-part-1-introduction/curated/03-natural-numbers.jpg)

但随着问题变复杂，自然数很快不够用了。土地分割、播种时间、金融记录都要求人们表达“整体的一部分”。于是分数进入数系，填补自然数之间的空隙。

![Denser number systems](../../youtube/slides/T647CGsuOVU-imaginary-numbers-are-real-part-1-introduction/curated/04-denser-number-systems.jpg)

这一步很重要，因为它把 imaginary numbers 放回一个更长的历史模式里：数学不是一开始就拥有完整数系，而是每当旧数系无法回答新问题时，就被迫扩展。

![Fractions fill gaps](../../youtube/slides/T647CGsuOVU-imaginary-numbers-are-real-part-1-introduction/curated/05-fractions-fill-gaps.jpg)
...
![History map](../../youtube/slides/T647CGsuOVU-imaginary-numbers-are-real-part-1-introduction/curated/06-history-map.jpg)
...
![Subtraction extends numbers](../../youtube/slides/T647CGsuOVU-imaginary-numbers-are-real-part-1-introduction/curated/07-subtraction-extends-numbers.jpg)
...
![Euler question](../../youtube/slides/T647CGsuOVU-imaginary-numbers-are-real-part-1-introduction/curated/08-euler-imaginary-question.jpg)
