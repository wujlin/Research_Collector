...
![series contact sheet](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/contact_sheet.jpg)
...
![no real solution](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/01-no-real-solution.jpg)
...
![Euler imaginary question](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/02-euler-imaginary-question.jpg)
...
![quadratic formula](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/03-quadratic-formula.jpg)
...
![Cardan problem](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/04-cardans-problem.jpg)
...
![sqrt minus one not on real line](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/05-sqrt-minus-one-not-on-real-line.jpg)

但它可以作为代数规则存在。关键不是“它像不像长度、数量、苹果个数”，而是它是否能和已有数系一起形成一致的运算系统。

![algebra with sqrt minus one](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/06-algebra-with-sqrt-minus-one.jpg)
...
![Bombelli conjugate terms](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/07-bombelli-conjugate-terms.jpg)

这说明虚数可以作为“中间语言”出现。即使最终结果是实数，推导路径也可能必须穿过复数空间。

![Bombelli real solution](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/08-bombelli-real-solution-through-imaginary.jpg)
...
![two dimensional number system](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/09-two-dimensional-number-system.jpg)
...
![complex number as point](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/10-complex-number-as-point.jpg)
...
![complex addition components](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/11-complex-addition-components.jpg)
...
![multiplication angle table](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/12-multiplication-angle-table.jpg)
...
![multiplication adds angles](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/13-multiplication-adds-angles.jpg)
...
![polar form](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/14-polar-form.jpg)
...
![roots of unity](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/15-roots-of-unity.jpg)
...
![many roots around circle](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/16-many-roots-around-circle.jpg)
...
![closure number systems](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/17-closure-number-systems.jpg)
...
![complex function two planes](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/18-complex-function-two-planes.jpg)
...
![complex function maps shapes](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/19-complex-function-maps-shapes.jpg)
...
![squaring map](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/20-squaring-map-in-two-planes.jpg)
...
![inverse two outputs](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/21-inverse-function-two-outputs.jpg)
...
![Riemann needs more planes](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/22-riemann-needs-more-than-two-planes.jpg)

这样得到的对象就是 Riemann surface。它把原来看起来“不连续”或“多值”的函数，重新放到一个更合适的几何空间中。

![Riemann surface](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/23-riemann-surface-as-glued-planes.jpg)

从学习角度看，这里有一个和前面完全一致的逻辑：当旧空间无法表达对象的真实结构时，不要只修补公式，而要扩展空间。

![complex surface visualization](../../youtube/slides/welch-labs-imaginary-numbers-are-real-curated/frames/24-complex-surface-visualization.jpg)
