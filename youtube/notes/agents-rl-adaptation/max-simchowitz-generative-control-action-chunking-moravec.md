...
![Moravec paradox](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-01-45_moravecs_paradox.jpg)
...
![Roadmap](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-03-43_talk_roadmap.jpg)
...
![BC challenge](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-05-17_why_robotic_bc_challenging.jpg)
...
![Test time error](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-09-17_test_time_error.jpg)
...
![Action chunking](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-19-35_inflection_point_action_chunking.jpg)

Action chunking 的核心是：policy 不再每个时间步只输出一个瞬时动作，而是输出一段动作序列。这样控制接口从高频点动作变成低频局部计划。

![Motivating action chunking](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-19-49_motivating_action_chunking.jpg)
...
![No free lunch](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-24-46_open_loop_stability_no_free_lunch.jpg)

所以 action chunking 不是魔法。它改变了误差传播方式，但最终仍然要受 dynamics stability 约束。

## 4. 27:06-35:36：generative control 不只是多模态动作分布

![Generative control](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-27-19_generative_control_policies.jpg)
...
![Distribution learning](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-35-36_distribution_learning_gcp.jpg)

这迫使我们问一个更深的问题：generative model 作为 policy 时，除了表达分布，还提供了什么计算结构？

## 5. 39:17-46:05：GCP 可能提供 inference-time computation

![Other uses](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-44-42_other_uses_gcps.jpg)
...
![Summary](../../slides/UX1YXcRnFbs-ri-seminar-max-simchowitz-generative-control-action-chunking-and-moravec-paradox/curated/00-46-05_inflection_point_summary.jpg)
