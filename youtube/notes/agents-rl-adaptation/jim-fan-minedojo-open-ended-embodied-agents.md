...
- Transcript: [transcript.md](../../transcripts/38996758-minedojo-building-openended-embodied-agents-internet-scale-knowledge/transcript.md)
- Slides: [curated/index.md](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/index.md)
...
![MineDojo title](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/01-title.png)
...
![Passive GPT-3 versus active generalist agent](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/02-active-kitten-vs-generalist-agent.png)
...
![Embodied GPT-3 capabilities](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/03-embodied-gpt3-capabilities.png)
...
![Today's agent limitations](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/04-todays-agent-limitations.png)
...
![Three ingredients overview](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/05-three-ingredients-overview.png)
...
![Open-ended environment rationale](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/06-open-ended-environment-rationale.png)
...
![Internet-scale knowledge rationale](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/07-internet-scale-knowledge-rationale.png)
...
![Foundation model for agents rationale](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/08-foundation-model-for-agents-rationale.png)

![Minecraft as low-fi Earth](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/09-minecraft-as-lofi-earth.png)
...
![Open-ended environment examples](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/10-open-ended-environment-examples.png)

![MineDojo simulator and task suite](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/11-minedojo-simulator-and-task-suite.png)
...
![Scalable task creation summary](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/12-scalable-task-creation-summary.png)
...
![YouTube task labeling UI](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/13-youtube-task-labeling-ui.png)
...
![GPT-3 step-by-step guidance](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/14-gpt3-step-by-step-guidance.png)

这一步有一个微妙但重要的点：GPT-3 在这里不是最终 agent，而是任务生态的辅助生成器。它的作用是利用文本世界知识帮助研究者扩展任务空间，但这些任务最终仍要回到 Minecraft 环境中，由 embodied agent 执行。

![Internet knowledge bases overview](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/15-internet-knowledge-bases-overview.png)
...
![YouTube gameplay video corpus](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/16-youtube-gameplay-video-corpus.png)

第二部分是 Wiki。Minecraft 社区已经整理了大量机制说明，包括怪物行为、合成配方、物品用途、方块属性和游戏规则。这类材料更像结构化世界知识，可以告诉 agent 世界里有哪些实体、它们之间有什么规则关系。

![Wiki structured world knowledge](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/17-wiki-structured-world-knowledge.png)

![Reddit player community corpus](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/18-reddit-player-community-corpus.png)

第三部分是 Reddit。玩家会在论坛里问问题、回答问题、展示失败案例和提供策略。例如“为什么我的小麦农场不生长”，社区回答可能指出光照不足。这类数据不像 Wiki 那样规整，但它包含了大量经验性因果知识：问题是什么，原因是什么，应该怎么修。

![Reddit problem-solving examples](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/19-reddit-problem-solving-examples.png)
...
![MineCLIP contrastive video-language model](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/20-mineclip-contrastive-video-language-model.png)
...
![MineCLIP as RL reward](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/21-mineclip-as-rl-reward.png)
...
![RL with MineCLIP full results](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/22-rl-with-mineclip-full-results.png)
...
![Generalization to new tasks](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/23-generalization-new-tasks.png)
...
![Generalization to visual robustness](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/24-generalization-visual-robustness.png)
...
![OpenAI VPT comparison](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/25-openai-vpt-comparison.png)
...
![Project website and open source](../../slides/38996758-minedojo-building-openended-embodied-agents-with-internetscale-knowledge/curated/26-project-website-and-open-source.png)
