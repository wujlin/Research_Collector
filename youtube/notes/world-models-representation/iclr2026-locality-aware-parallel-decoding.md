...
![Autoregressive image generation](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/02-autoregressive-image-generation.jpg)
...
![Title](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/01-title-locality-aware-decoding.jpg)
...
![Two paradigms](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/03-two-paradigms-ar-generation.jpg)

所以作者提出的问题是：能不能同时保留 flat token 的多模态兼容性，又获得接近并行生成的速度？

![Fast multimodal-compatible AR](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/04-fast-multimodal-compatible-ar.jpg)
...
![Flexible parallelized AR modeling](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/05-flexible-parallelized-ar-modeling.jpg)

这样，模型就可以在同一次 forward pass 中指定任意一组目标位置，比如同时预测位置 3 和 5。context token 和 generation query 分离后，顺序和并行度都变成可控变量。

![Flexible superposition modeling](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/06-flexible-superposition-modeling.jpg)
...
![Specialized attention mask](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/07-specialized-attention-mask.jpg)
...
![Inference step](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/08-inference-step.jpg)
...
![Order and degree choice](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/09-order-degree-choice.jpg)
...
![Existing orders fail](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/10-existing-orders-fail.jpg)
...
![Locality-aware ordering](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/11-locality-aware-generation-ordering.jpg)
...
![Results](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/12-results-speed-quality.jpg)

![Visualizations](../../slides/cPeGBXXHxZM-locality-aware-parallel-decoding-for-efficient-autoregressive-image-generation/curated/13-visualizations.jpg)
