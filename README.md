...
每日学习和视野演化流程见 [`docs/daily_learning_evolution_workflow.md`](docs/daily_learning_evolution_workflow.md)。除论文和视频外，个人分支也把重要书籍、方法材料和长期课程纳入“远端解析 -> 本地轻量笔记 -> 说明文档/知识卡片 -> 未来知识 skill 候选”的学习演化链条。`writing-research-craft` 只保留研究与写作方法；每日领域知识先在文档中成熟，之后再逐步抽成知识 skill。
