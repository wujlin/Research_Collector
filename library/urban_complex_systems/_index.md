...
- [A Matrix-Driven Cellular Automata Model for Analyzing Urban Decay and Vitality Indicators at the Neighborhood Scale](a-matrix-driven-cellular-automata-model-for-analyzing-urban-decay-and-vitality-i.md) (2026, Buildings, 0 citations)
...
- [Reconstructing Land Surface Temperature for Cloud-Covered Regions: A Review of Methods](reconstructing-land-surface-temperature-for-cloud-covered-regions-a-review-of-me.md) (2026, preprint, 0 citations)

- [Deep learning-based high-speed railway communication systems](deep-learning-based-high-speed-railway-communication-systems.md) (2026, Scientific Reports, 0 citations)

- [A Large Language Model for Traffic Flow Prediction Based on Stationary Wavelet Transform and Graph Convolutional Networks](a-large-language-model-for-traffic-flow-prediction-based-on-stationary-wavelet-t.md) (2026, ISPRS International Journal of Geo-Information, 0 citations)

- [Establishes a technical and academic bridge between the educational systems of the Democratic Republic of the Congo (DRC) and the South African Qualifications Authority (SAQA). It focuses on the harmonization of skills through a robust management information system (MIS) and rigorous research methodology](establishes-a-technical-and-academic-bridge-between-the-educational-systems-of-t.md) (2026, preprint, 0 citations)

- [Comprehensive Characterization of Volatile Flavor Compounds in Thamnaconus modestus Under Different Thermal Processing Methods: A Multi-Instrumental Flavoromics Approach](comprehensive-characterization-of-volatile-flavor-compounds-in-thamnaconus-modes.md) (2026, Foods, 0 citations)

- [Stochastic equations and cities](stochastic-equations-and-cities.md) (2023, arXiv, 0 citations)
