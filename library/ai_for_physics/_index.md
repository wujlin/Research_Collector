...
- [Resolution-independent generative models based on operator learning for physics-constrained Bayesian inverse problems](resolution-independent-generative-models-based-on-operator-learning-for-physics.md) (2023, ArXiv, 17 citations)
...
- [ScoRe-Flow: Complete Distributional Control via Score-Based Reinforcement Learning for Flow Matching](score-flow-complete-distributional-control-via-score-based-reinforcement-learnin.md) (2026, ArXiv.org, 0 citations)
...
- [Rethinking the Diffusion Model from a Langevin Perspective](rethinking-the-diffusion-model-from-a-langevin-perspective.md) (2026, arXiv (Cornell University), 0 citations)
...
- [Probabilistic Prediction of Neural Dynamics via Autoregressive Flow Matching](probabilistic-prediction-of-neural-dynamics-via-autoregressive-flow-matching.md) (2026, arXiv (Cornell University), 0 citations)

- [SubFlow: Sub-mode Conditioned Flow Matching for Diverse One-Step Generation](subflow-sub-mode-conditioned-flow-matching-for-diverse-one-step-generation.md) (2026, arXiv (Cornell University), 0 citations)

- [PRiMeFlow: Capturing Complex Expression Heterogeneity in Perturbation Response Modelling](primeflow-capturing-complex-expression-heterogeneity-in-perturbation-response-mo.md) (2026, ArXiv.org, 0 citations)

- [ISPAT-3D: Spatially Varying Conditional Volumetric Network Estimation for 3D Tumor Imaging](ispat-3d-spatially-varying-conditional-volumetric-network-estimation-for-3d-tumo.md) (2026, bioRxiv (Cold Spring Harbor Laboratory), 0 citations)
...
- [Physics-Informed Generative Neural Networks for RF Propagation Prediction with Application to Indoor Body Perception](physics-informed-generative-neural-networks-for-rf-propagation-prediction-with-a.md) (2024, 2024 18th European Conference on Antennas and Propagation (EuCAP), 6 citations)
...
- [Latent Diffusion Model for Chlorophyll Remote Sensing Spectral Synthesis Integrating Bio-Optical Priors and Band Attention Mechanisms](latent-diffusion-model-for-chlorophyll-remote-sensing-spectral-synthesis-integra.md) (2026, Applied Sciences, 0 citations)
...
- [Universr: Unified and Versatile Audio Super-Resolution Via Vocoder-Free Flow Matching](universr-unified-and-versatile-audio-super-resolution-via-vocoder-free-flow-matc.md) (2026, preprint, 0 citations)
...
- [RFM-Editing: Rectified Flow Matching for Text-Guided Audio Editing](rfm-editing-rectified-flow-matching-for-text-guided-audio-editing.md) (2026, preprint, 0 citations)
...
- [Preconditioned One-Step Generative Modeling for Bayesian Inverse Problems in Function Spaces](preconditioned-one-step-generative-modeling-for-bayesian-inverse-problems-in-fun.md) (2026, preprint, 0 citations)
